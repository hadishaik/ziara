...
const Careers = () => {
  return (
    <section className="bg-gray h-screen">
      <NavigatePrev />
      <div className="mx-auto max-w-xl px-4 py-10 text-darkGray lg:max-w-screen-lg">
        ...
        <div className="flex flex-col lg:flex-row">
          <div className="self-center pr-5 lg:w-1/2">
            <p className="mb-4 text-base">
              ...
              amet laborum iste distinctio modi soluta fuga officia odio
              laudantium?
            </p>
            <p className="mb-4 text-base">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Perspiciatis et maiores ex numquam repellat? Iure, illum illo nisi
              explicabo deleniti amet sapiente repudiandae blanditiis ullam esse
              nostrum neque eveniet impedit nesciunt, sint inventore
              reprehenderit cumque! Vero dolor facere cumque ad.
            </p>
            <hr className="mt-8 h-2 w-20 transform border-none bg-lightPink" />
          </div>
          <div className="mt-8 grid flex-wrap gap-y-8 sm:grid-cols-2 lg:mt-0 lg:ml-4 lg:w-1/2 lg:gap-y-10">
            <div className="flex items-center">
              <div className="mr-3 rounded-full bg-lightPink p-6 text-7xl">
                {/* <!-- cil:wheelchair --> */}
                <svg
